...
const LoginPage = () => {
  return (
    <div className="flex justify-center items-center h-svh relative w-full">
      <div className="flex gapy-2 flex-col items-center justify-center">
        <img className="w-18" src={Logo} alt="Rearticle Logo" />
        <div className="flex gap-y-6 flex-col items-center justify-center">
          <h3 className="text-3xl text-[#424242] font-bold">
            Tell us about you
          </h3>
          <input
            type="text"
            class="border border-gray-300 rounded-md pl-4 pr-20 py-2 w-full focus:outline-none focus:border-blue-500 "
          ...
          ></input>
          <p className="text-[#424242b3] text-xs/[22px] font-medium cursor-default">
